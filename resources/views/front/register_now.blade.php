			...
			<div class="container">
				<div class="row">
					<div class="booking-form">
						...
						<form action="{{url('/register_training_now')}}" method="POST">
							<div class="row">
								<div class="col-sm-4">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input name="company" class="form-control" type="tel" placeholder="Enter your phone number">
									</div>
								</div>
                            ...
                            <div class="row">
							    <div class="col-sm-6">
									<div class="form-group">
										...
										<input name="number" class="form-control" type="number" placeholder="e.g 12">
									</div>
                                </div>
								<div class="col-sm-6">
									<div class="form-group">
										<span class="form-label">Mode of Learning</span>
										<input name="mode" readonly value="{{$Course->mode}}" class="form-control" type="text" placeholder="e.g 12">
									</div>
                                </div>
							...
							<input type="hidden" name="training" value="{{$Course->title}}">
							<div class="form-btn">
								<button type="submit" class="submit-btn">Register Now <span class="fa fa-send"></span></button>
							</div>
						</form>
					</div>
				</div>
