				...
				@endforeach
					<div class="col-lg-6">
						<div id="contact_form">
							...
							<form action="{{url('/request_link_send_structure')}}" method="POST" class="comment_form">
								@foreach($Courses as $publication)
								...
								@endforeach
								<div>
									<button type="submit" class="btn btn-primary btn-outline btn-lg"><span class="fa fa-download"><span>  Download </button>
								</div>
							</form>
						</div>
					</div>
