          ...
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-12">
              <h3 class="mt-0 line-bottom">Make a Donation<span class="font-weight-300"> Now!</span></h3>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group mb-20">
                        ...
                        <select name="item_name" class="form-control">
						  <?php $Ongoing =  DB::table('portfolio')->where('status','0')->get(); ?>
						  @foreach($Ongoing as $ongoing)
						  <option value="{{$ongoing->title}}">{{$ongoing->title}}</option>
						  @endforeach
                        </select>
                      </div>
                    </div>
				...
				<?php $PaypalEmail = DB::table('sitesettings')->get(); ?>
				@foreach($PaypalEmail as $paypal)
                <!-- Paypal Onetime Form -->
                <form id="popup_paypal_donate_form-onetime" class="hidden" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                  ...
                  <input type="hidden" name="cancel_return" value="{{url('/')}}/donate-now">
                  <input type="hidden" name="notify_url" value="{{url('/')}}/notifypayment">
