            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <center><h2> Edit {{$Admin->name}} </h2></center>
                    </div>
                </div>
                  <hr />
                 <!--BLOCK SECTION -->
              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/edit_Team')}}/{{$Admin->id}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <select name="type" data-placeholder="Choose Category" class="form-control chzn-select" tabindex="2">
                                ...
                                <option value="{{$Admin->type}}">@if($Admin->type == 1) Board of Directors @elseif($Admin->type == 2) Management @else Valunteer Coordinator @endif</option>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="{{url('/')}}/uploads/team/{{$Admin->image}}" alt="" /></div>
