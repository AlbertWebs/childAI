               ...
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/about_save')}}" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="div-1" class="body collapse in">
                                        ...
                                        <textarea name="vision" id="wysihtml5" class="form-control" rows="10">{{$value->vision}}</textarea>
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="div-1" class="body collapse in">
                                        ...
                                        <textarea name="mission" id="wysihtml5" class="form-control" rows="10">{{$value->mission}}</textarea>
                    ...
                    <div class="form-group col-lg-12">
                        <label class="control-label">Banner Three</label>
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="{{url('/')}}/uploads/images/{{$value->image_one}}" alt="" /></div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                <div>
                    ...
                    <div class="form-group col-lg-12">
                        <label class="control-label">About Banner</label>
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="{{url('/')}}/uploads/images/{{$value->image_two}}" alt="" /></div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                <div>
                    ...
                    <input type="hidden" name="image_one_cheat" value="{{$value->image_one}}">
                    <input type="hidden" name="image_two_cheat" value="{{$value->image_two}}">
