				...
				@endif
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input name="tags" id="tags" value="{{$Blog->tag}}" class="form-control" />
                            <p class="help-block">type in the tag then press Enter</p>
                        </div>
                    </div>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="link" value="{{$Blog->link}}" placeholder="MKH6jkh-g" class="form-control" />
                            <iframe width="100%" height="315"
                                src="https://www.youtube.com/embed/{{$Blog->link}}">
                            </iframe> 
                            <p class="help-block">Leave it blank if the blog has no video</p>
