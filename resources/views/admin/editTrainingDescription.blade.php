              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/edit_training_details')}}/{{$Course->id}}" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="div-1" class="body collapse in">
                                        ...
                                        <textarea name="content" id="wysihtml5" class="form-control" rows="100">{{$Course->content}}</textarea>
