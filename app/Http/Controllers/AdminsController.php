...
public function addRegion(){
    ...
    return view('admin.addRegion',compact('page_title','page_name'));
}
...
public function add_Region(Request $request){
    ...
    $Region->slung = $slung;
    $Region->meta = $request->meta;
    $Region->content = $request->content;
    $Region->location = $request->location;
    $Region->address = $request->address;
    $Region->email = $request->email;
    $Region->email_one = $request->email_one;
    $Region->mobile = $request->mobile;
    $Region->mobile_one = $request->mobile_one;

    $Region->save();

    Session::flash('message', "Region Has Been Added");
    return Redirect::back();
}
...
public function regions(){
    ...
    $page_title = 'list';
    $page_name = 'Region';
    return view('admin.regions',compact('page_title','Region','page_name'));
}
...
public function editRegion($id){
    ...
    return view('admin.editRegion',compact('page_title','Region','page_name'));
}
...
public function edit_Region(Request $request, $id){
    ...
    DB::table('regions')->where('id',$id)->update($updateDetails);
    Session::flash('message', "Changes have been saved");
    return Redirect::back();
}
...
public function reasons(){
    ...
    $page_title = 'list';
    $page_name = 'reasons';
    return view('admin.reasons',compact('page_title','Reason','page_name'));
}
public function addReason(){
    $page_title = 'formfiletext';
    $page_name = 'Add Category';
    return view('admin.addReason',compact('page_title','page_name'));
}

public function add_Reason(Request $request){

    $Reason = new Reason;
    $Reason->title = $request->name;
...
public function editReason($id){
    ...
    $page_title = 'formfiletext';
    $page_name = 'Edit Home Page Slider';
    return view('admin.editReason',compact('page_title','Reason','page_name'));
}
...
public function edit_Reason(Request $request, $id){
    ...
    DB::table('reasons')->where('id',$id)->update($updateDetails);
    Session::flash('message', "Changes have been saved");
    return Redirect::back();
}
